// Raffle
// Enter ther lottery (paying some amount)
//Pick a random winner(verifable random)
// Winner to be selected every X minutes -> completly automated
// Chainlink Oracle -> Randomness, Automated Excution(Chainlink keerpers)
...
abstract contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /* State Variables */
    uint256 private immutable i_entranceFee; // the free to take a possibility to win
    address payable[] private s_players; // the list of players of the the Raffle
    VRFCoordinatorV2Interface private immutable i_vrfCoordinator; // This is the addres of the contract to make the random
    ...
    function enterRaffle() public payable {
        ...
        s_players.push(payable(msg.sender)); // insert de new sender

        // Events when we update a dynamic object
